...
-- ตารางเกณฑ์มาตรฐาน AI ประจำตำแหน่ง (สำหรับหน้า "เทรนโมเดล AI")
CREATE TABLE job_training_profiles (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- [FUTURE] ตารางสำหรับคณะ/วิทยาลัย (ยังไม่สร้าง — เตรียมไว้สำหรับอนาคต)
